...
use Pln\ForumLearning\Http\Requests\StoreTopicPost;
use Pln\ForumLearning\Modules\Forum\Services\ForumService;
use Pln\ForumLearning\Http\Requests\StoreCommentPost;
use Pln\ForumLearning\Models\Forum\ForumMasterTagModel;
...
class UserController extends Controller
{
    ...
    public function index(UsersDataTable $datatables)
    {
        ...
        // );
        return $datatables->render('backend.pages.users');
    }
